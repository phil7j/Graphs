...
def find_path():
    ...
    #   if not in visited : add as a key to the 'visited' object, then add directions as value
        ...
        # Otherwise if no question marks found, go back to previous room
            ...
            # Find the path to the nearest enexplored room
                ...
                while q.size() > 0:
                    ...
                    if v not in visited_rooms:
                        ...
                        for key, value in visited[v].items():
                            ...
                            q.enqueue(path_copy)
            # returns [14,13,12,1,0]
            if bfs(cur_room) is None:
            ...
            path_to_exit = bfs(cur_room)
            # print("THIS IS THE WAY: ", path_to_exit)
            new_traverse = []
            # print("NEW TRAVERSE: ", new_traverse)
...
for move in traversalPath:
    # print("Move:", move)
    # print("Current:", player.currentRoom)
    player.travel(move)
    visited_rooms.add(player.currentRoom)
